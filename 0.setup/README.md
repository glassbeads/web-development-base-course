...
Названия с `.` - практика, начавшаяся в операционных системах семейства Unix. В них, файлы и папки, названия которых начинаются с `.`, скрыты. В такие файлы и папки обычно помещают вещи, которые лучше скрывать от глаз обычных пользователей - это какие-то настройки софта, кэши, прочее.
